...
exports.UIRouterContextComponent = void 0;
...
function UIRouterContextComponent(props) {
    ...
    return (React.createElement(react_2.UIRouterContext.Provider, { value: (inherited && routerFromReactContext) || contextFromAngularJS.router },
        React.createElement(react_2.UIViewContext.Provider, { value: (inherited && parentUIViewFromReactContext) || contextFromAngularJS.addr }, childrenCount === 1 && !isArray ? React.Children.only(children) : React.createElement("div", null, children))));
}
