...
exports.UISrefActive = exports.UISrefActiveContext = void 0;
...
function UISrefActive(_a) {
    ...
    var childrenWithActiveClasses = isAnyUiSrefActive
        ? react_1.cloneElement(children, __assign(__assign({}, children.props), { className: classnames_1.default(className, children.props.className, classToApply) }))
        : children;
